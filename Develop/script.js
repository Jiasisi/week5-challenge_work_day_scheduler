...
var timeSheetEl = $('#timeSheet');


var eightAM = $('hour-8').children().eq(1).val();
console.log(eightAM);
...
$(function () {
  ...
  $('.saveBtn').on('click', function() {
    ...
    localStorage.setItem("savedDescription", JSON.stringify(userInput));
...
//      descriptionEl = savedDescription;
